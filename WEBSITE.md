...
- The paper PDF is the supplied five-page `ICASSP2027_SythenticTTS_Luoji (1).pdf`,
  synchronized on 20 September 2026. Figure 1 is rendered from its second page.
