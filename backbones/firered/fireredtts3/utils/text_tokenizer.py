...
MULTI_LANG_TAGS = [
    ...
    "<|Czech|>", "<|Finnish|>", "<|Hindi|>",
    # The released Qwen embedding table has spare rows beyond the tokenizer
    # length.  This token occupies one of those rows and is adapted through the
    # TTS LoRA modules; no embedding resize is required.
    "<|Burmese|>",
    "<|Lao|>",
]
...
def load_text_tokenizer(tokenizer_dir:str):
    ...
    special_tokens = [
        ...
        "<|placeholder_192|>",
        # Multi-lang tag
        *[tag for tag in MULTI_LANG_TAGS if tag != "<|Lao|>"],
        # Multi-dialect tag
        *MULTI_DIALECT_TAGS,
        # For SpeechEdit CoT
        "<|edit|>", "<|frame_patch|>", "<|end_edit|>",
        # Append the new language LAST to preserve every existing token ID.
        "<|Lao|>",
    ]
